...
const Gallery = () => {
  ...
  const allImages = [...galleryImages, ...facebookImages];
  ...
  // Handle Facebook images loaded
  const handleFacebookImagesLoaded = (images) => {
    setFacebookImages(images);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* Facebook Gallery Integration - Hidden component that loads Facebook images */}
        <div style="display: none;">
          <FacebookGallery 
            pageId="YOUR_FACEBOOK_PAGE_ID" 
            accessToken="YOUR_FACEBOOK_ACCESS_TOKEN"
            category="facebook"
            onImagesLoaded={handleFacebookImagesLoaded}
          />
        </div>
        ...
        <div className="py-8 bg-gray-50">
          <div className="container mx-auto px-4">
            {activeCategory === 'facebook' && facebookImages.length === 0 && (
              <div className="text-center py-12">
                <div className="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-blue-500 mb-4"></div>
                <p className="text-gray-600">Loading Facebook images...</p>
              </div>
            )}
